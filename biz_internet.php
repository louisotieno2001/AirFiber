...
<head>
	<meta charset="UTF-8">
	<title>Biz Internet - AirFiber | AirFiber</title>
...
<body
	class="page-template page-template-page-product page-template-page-product-php page page-id-13 page-child parent-pageid-8">
		...
		<div class="wrap">
			<div class="masthead__left">
				<ul class="menu-main" role="navigation">
					<li id="menu-item-113"
						class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-113">
						<a href="#">Products</a>
						<ul class="sub-menu">
							<li id="menu-item-51"
							...
							<li id="menu-item-50"
								class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-13 current_page_item menu-item-50">
								<a href="redirect.php?link=biz_internet.php" aria-current="page">Biz Internet</a></li>
						</ul>
					</li>
					<li id="menu-item-41"
			...
			<div class="masthead__right">
				<ul class="menu-right" role="navigation">
					...
					<li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-44">
						<a href="redirect.php?link=airfiber_get_connected.php" style="background-color: #001C30;">Get
							Connected</a></li>
				</ul>
			</div>
		</div>
	...
	<section class="banner" style="background-color: #93c580;">
		<div class="wrap">
			...
			<article class="col col--txt">
				...
				<h2 style="color: #001C30;">Custom-made to match your business needs</h2>
				<p>We will work with you and develop a solution that matches your present and future business needs. Our
					goal is to ensure that what we offer works for you!</p>

			</article>

			<div class="col col--img">
				<div class="inner">
					<img src="./Res/bg-biz-internet.jpg">
				</div>
			</div>
	...
	<section class="row" id="content">
		<div class="wrap">
			<div class="pricing">
				<div class="col">
					<div class="card" style="background-color:#001C30;border-color:#001C30;">
						<h3>Biz</h3>
						<h2>Unlimited <span>Internet</span></h2>
						<div class="product-details">With a simple and clear pricing structure, we offer an array of
							internet packages ranging from shared to dedicated connections.</div>
						<p class="product-cta"><a href="redirect.php?link=airfiber_get_connected.php"
								class="button button--primary" style="background-color:#001C30;">Get connected</a></p>
					</div>
				</div>
				<div class="col">
					<div class="card" style="background-color:#001C30;border-color:#001C30;">
						<h3>Biz</h3>
						<h2>Bespoke <span>Solutions</span></h2>
						<div class="product-details">We will work with you and develop a solution that matches your
							present and future business needs. Our goal is to ensure that our offer works for you!</div>
						<p class="product-cta"><a href="redirect.php?link=airfiber_get_connected.php"
								class="button button--primary" style="background-color:#001C30;">Get connected</a></p>
					</div>
				</div>
				<div class="col">
					<div class="card" style="background-color:#001C30;border-color:#001C30;">
						<h3>Biz</h3>
						<h2>VAS <span>Value Added Services</span></h2>
						<div class="product-details">We offer additional services such as: public IP, extension
							management, managed firewall, etc. </div>
						<p class="product-cta"><a href="redirect.php?link=airfiber_get_connected.php"
								class="button button--primary" style="background-color:#001C30;">Get connected</a></p>
					</div>
				</div>
	...
	<footer class="bothom" id="footer">
		...
		<div class="bothom__mwisho">
			<div class="wrap">
				<div class="footer-col4">
					<p class="small">AirFiber &copy; 2023. All rights reserved.</p>
				</div>
				<div class="footer-col4">
				</div>
				<div class="footer-col4">
					...
					<li
						...
						<ul class="sub-menu">
							<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-67"><a
									href="redirection.php?link=airfiber_email.php">Email Us</a></li>
						</ul>
					</li>
				</ul>
			</div>
